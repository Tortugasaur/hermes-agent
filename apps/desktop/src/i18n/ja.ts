...
export const ja = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      approvalMenuLabel: '自動承認',
      approvalMenuTitle: 'Hermes のアクションをどう承認しますか？',
      approvalAsk: '毎回確認',
      approvalAskDescription: '外部ファイルの編集とインターネット使用は常に確認する',
      approvalSmart: 'スマート承認',
      approvalSmartDescription: '危険な可能性がある操作だけ確認する',
      approvalFull: 'フルアクセス',
      approvalFullDescription: 'インターネットとこのコンピューター上のすべてのファイルへの無制限アクセス',
      modelNone: 'なし',
      noModel: 'モデルなし',
