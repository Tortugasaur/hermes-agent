...
export const zhHant = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      approvalMenuLabel: '為我核准',
      approvalMenuTitle: 'Hermes 動作應如何核准？',
      approvalAsk: '每次詢問',
      approvalAskDescription: '一律詢問是否編輯外部檔案和使用網際網路',
      approvalSmart: '智慧核准',
      approvalSmartDescription: '只對偵測為可能不安全的動作詢問',
      approvalFull: '完整存取',
      approvalFullDescription: '不受限制地存取網際網路和你電腦上的任何檔案',
      modelNone: '無',
      noModel: '無模型',
      switchModel: '切換模型',
